...
export function Timeline({ checks, range }: TimelineProps) {
  ...
  const showTooltip = (el: HTMLElement, bucket: typeof buckets[0]) => {
  ...
  return (
    <div className="space-y-2">
      <div className="flex h-6 gap-0.5" role="group" aria-label="Uptime history timeline">
        {buckets.map((bucket, i) => (
          <div
            ...
            className={cn(
              "flex-1 rounded-sm transition-colors outline-none",
              "focus-visible:ring-1 focus-visible:ring-indigo-500 focus-visible:relative z-10",
